...
一个给孩子使用的背单词小程序，支持中考、高考、KET、PET、2000词、4000词、自定义词库和 Unlock 3 独角兽背单词。
独角兽词库支持第一到第五单元，并支持名字 + 密码的云同步进度。
...
进入小程序底部的“设置”，找到“云同步登录”。

- 第一次输入孩子名字和密码会自动创建档案。
- 以后在其他设备输入同样的名字和密码，会同步学习进度、错词、星星和自定义词。
- 密码只保存加盐哈希，不保存明文。

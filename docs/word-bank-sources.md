...
- 软件中建议命名为“黑龙江中考词库”，内部保留来源分层：`课标基础`、`黑龙江真题补充`。
...
- 初筛数量：1713 个词头。
- 仍需清洗英美拼写、斜杠词、括号词，例如 `yog(h)urt` 应整理为可学习词，而不是机械截断。
...
1. 清洗并整理 KET A2 Key 完整词头。
2. 为 KET 生成儿童学习版中文释义和例句，抽样核对后导入软件。
3. 继续确认 PET 完整词表来源；确认前只保留 PET 起步词库。
4. 整理高考新课标完整版词库。
5. 整理黑龙江中考词库，分为课标基础和黑龙江真题补充。
